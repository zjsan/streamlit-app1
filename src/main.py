...
#sidebar
with st.sidebar:
    st.title("CogniCraft - Smart Exam Question Generation With AI and Bloom's Taxonomy - Main.py")
    st.markdown('''
    ## About
...
def display_response_history():
    ...
    response_history = st.session_state.generated  # Assuming this holds the response history
